...
const AddWorker = (props) => {
  ...
  return (
    ...
    <form className="flex flex-col gap-y-2" onSubmit={addWorkerHandler}>
      ...
      <input className="max-w-[40rem] w-full mx-auto border p-2" type="text" placeholder="Çalışan ismi yazınız" id="name" onChange={workerNameChangeHandler}
      value={enteredWorkerName}/>
      <label htmlFor="wage" className="font-medium"> Maaş Miktarı </label>
      <input className="max-w-[40rem] w-full mx-auto border p-2"  type="number" placeholder="Maaş miktarı yazınız" id="wage" onChange={wageChangeHandler}
      value={enteredWage}/>
